...
async function handleRequest(request) {
  ...
  // 1b. /kategori/ → trailing slash zorunlu (v3.8)
  // Origin DLL, SEF_URL trailing slash ile eşleşir — slash yoksa ekle
  if (pathname.startsWith('/kategori/') && !pathname.endsWith('/')) {
  ...
  // 1c. Trailing slash → 301 redirect (v3.7 — canonical hygiene)
  ...
  // 7. ─── v3.5 maintenance logic KALDIRILDI (v3.7) ───
  //    Origin artık stabil, 500→503 dönüşümü gerekmez.
